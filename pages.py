...
:root{{
  ...
  --t1:#f5f5f5;--t2:#cccccc;--t3:#888888;
  --radius:18px;--shadow:0 12px 40px rgba(0,0,0,0.45);
  --serif:'Vazirmatn',sans-serif;
}}
[data-theme="light"]{{
  --bg:#F0F3FA;--bg2:#E5ECF8;--bg3:#D9E3F4;
  --card:#FFFFFF;--card-b:rgba(255,107,0,0.14);--card-bh:rgba(255,107,0,0.32);
  --accent:#E65C00;--accent2:#CC5200;--accent-d:rgba(230,92,0,0.08);
...
.brand-img{{width:40px;height:40px;border-radius:50%;overflow:hidden;border:1px solid var(--card-b);box-shadow:0 0 14px rgba(139,92,246,.3),0 0 8px rgba(255,107,0,.25);flex-shrink:0}}
...
.copy-all-bar{{display:flex;align-items:center;gap:12px;background:linear-gradient(120deg,var(--accent) 0%,#CC5200 100%);border-radius:18px;padding:16px 19px;margin-bottom:18px;box-shadow:0 10px 30px rgba(255,107,0,.28);flex-wrap:wrap}}
...
.copy-all-btn{{background:#fff;color:#CC5200;border:none;border-radius:12px;padding:10px 19px;font-family:inherit;font-size:12.5px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:6px;transition:.18s;white-space:nowrap}}
...
[data-theme="light"] .cfg-vless{{background:rgba(230,92,0,.05)}}
...
[data-theme="light"] .lock-inp{{background:rgba(230,92,0,.04)}}
...
<div class="wrap">
  <div class="top">
    <div class="brand">
      <div class="brand-img"><img src="data:image/png;base64,{logo}" alt="TK-Ui"></div>
...
function renderContent(d){{
  ...
  window._tkuiSubUrl  = subUrl;
  window._tkuiSubName = d.name;
  window._tkuiLinks   = d.links.map(l => ({{
    vless : l.vless_link,
    ...
    <div class="sub-info">
      ...
      <div class="sub-sub-box">
        ...
        <button class="btn btn-pur" style="padding:7px 12px;font-size:10.5px"
          onclick="navigator.clipboard.writeText(window._tkuiSubUrl).then(()=>toast('لینک ساب کپی شد ✓','ok'))">
          <i class="ti ti-copy"></i> کپی لینک ساب
        </button>
        <button class="btn btn-g" style="padding:7px 12px;font-size:10.5px"
          onclick="showQR(window._tkuiSubName + ' — کل گروه', window._tkuiSubUrl)">
            ...
            <div class="cfg-bottom">
              ...
              <div class="cfg-actions">
                <button class="btn btn-p"
                  onclick="navigator.clipboard.writeText(window._tkuiLinks[${{i}}].vless).then(()=>toast('لینک کپی شد ✓','ok'))">
                  <i class="ti ti-copy"></i> کپی لینک
                </button>
                <button class="btn btn-g"
                  onclick="showQR(window._tkuiLinks[${{i}}].label, window._tkuiLinks[${{i}}].vless)">
...
init();
    ...
    return template.format(logo=LOGO_B64, uuid_key=uuid_key)

# جایگزینی لوگو در دو صفحه‌ی استاتیک
...
:root{--bg:#0a0a0a;--card:rgba(20,20,20,0.9);--accent:#FF6B00;--text:#f5f5f5;--dim:#666;--mid:#aaa;--border:rgba(255,107,0,0.2)}
...
.grid{position:fixed;inset:0;background-image:linear-gradient(rgba(255,107,0,0.04) 1px,transparent 1px),linear-gradient(90deg,rgba(255,107,0,0.04) 1px,transparent 1px);background-size:44px 44px;z-index:0}
.orb{position:fixed;border-radius:50%;filter:blur(90px);z-index:0;animation:fl 9s ease-in-out infinite}
.o1{width:380px;height:380px;background:rgba(255,107,0,0.07);top:-100px;right:-80px}
...
.card{background:var(--card);border:1px solid var(--border);border-radius:20px;padding:38px 34px 34px;backdrop-filter:blur(24px);box-shadow:0 0 80px rgba(255,107,0,0.07),0 20px 60px rgba(0,0,0,.5)}
.brand{display:flex;align-items:center;gap:14px;margin-bottom:28px}
.brand-img{width:48px;height:48px;border-radius:50%;overflow:hidden;border:1px solid var(--border);box-shadow:0 0 20px rgba(139,92,246,0.35),0 0 12px rgba(255,107,0,0.3);flex-shrink:0}
.brand-img img{width:100%;height:100%;object-fit:cover}
...
input[type=password]:focus{border-color:rgba(255,107,0,.55);background:rgba(0,0,0,.4);box-shadow:0 0 0 3px rgba(255,107,0,.1)}
...
:root{
  --bg:#0a0a0a;--bg2:#141414;--bg3:#1a1a1a;
  --card:#141414;--card-b:rgba(255,107,0,0.15);--card-bh:rgba(255,107,0,0.35);
  --accent:#FF6B00;--accent2:#E67E22;--accent-d:rgba(255,107,0,0.12);
...
[data-theme="light"]{
  ...
  --card:#FFFFFF;--card-b:rgba(255,107,0,0.15);--card-bh:rgba(255,107,0,0.35);
  --accent:#E65C00;--accent2:#CC5200;--accent-d:rgba(230,92,0,0.08);
...
.logo-img{width:38px;height:38px;border-radius:50%;overflow:hidden;border:1px solid var(--card-b);box-shadow:0 0 14px rgba(139,92,246,.3),0 0 8px rgba(255,107,0,.25);flex-shrink:0}
...
.btn-p:hover{background:#E65C00;box-shadow:0 4px 18px rgba(255,107,0,.4)}
...
.fi:focus,.fs:focus{border-color:rgba(255,107,0,.45);background:rgba(0,0,0,.25);box-shadow:0 0 0 3px rgba(255,107,0,.08)}
...
[data-theme="light"] .cp-block{background:rgba(230,92,0,.03)}
...
[data-theme="light"] .srv-tile{background:rgba(230,92,0,.03)}
...
<div class="mob-top">
  <div class="ml">
    <div class="mob-logo"><img src="data:image/png;base64,__LOGO_B64__" alt="TK-Ui"></div>
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">TK-Ui v9.2 · Railway</span>
    <a class="df-link" href="https://t.me/TaaKaaOrg" target="_blank"><i class="ti ti-brand-telegram"></i> t.me/TaaKaaOrg</a>
  ...
  <div class="srv-panel">
    ...
    <div class="srv-tiles">
      <a class="srv-tile" href="https://t.me/TaaKaaOrg" target="_blank" style="text-decoration:none;cursor:pointer">
        ...
        <div class="srv-tile-text"><div class="srv-tile-label">آیدی تلگرام</div><div class="srv-tile-val">@TaaKaaOrg</div></div>
      </a>
      <a class="srv-tile" href="https://t.me/TaaKaaOrg" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-users-group"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">گروه تلگرام</div><div class="srv-tile-val">t.me/TaaKaaOrg</div></div>
      </a>
      <a class="srv-tile" href="https://t.me/TaaKaaOrg" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-speakerphone"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">کانال تلگرام</div><div class="srv-tile-val">t.me/TaaKaaOrg</div></div>
      </a>
...
async function createLink(){
  const label=document.getElementById('nl-label').value.trim()||''; // empty will trigger auto
...
function initCharts(){
  ...
  const grad1=makeGradient(c1,'rgba(255,107,0,.38)','rgba(255,107,0,0)');
  const opts={
    ...
    plugins:{
      ...
      tooltip:{
        backgroundColor:'rgba(20,20,20,.96)',borderColor:'rgba(255,107,0,.3)',borderWidth:1,
        titleColor:'#f5f5f5',bodyColor:'#cccccc',padding:11,cornerRadius:10,displayColors:false,
    ...
    scales:{
      x:{grid:{display:false},border:{display:false},ticks:{color:'#888888',font:{size:9,family:'Vazirmatn'}}},
      y:{grid:{color:'rgba(255,107,0,.06)'},border:{display:false},ticks:{color:'#888888',font:{size:9,family:'Vazirmatn'},callback:v=>v+' MB'}}
    },
    elements:{line:{capBezierPoints:true}}
  };
  const ds1={label:'MB',data:[],borderColor:'#FF6B00',backgroundColor:grad1,fill:true,tension:.42,pointRadius:0,pointHoverRadius:6,pointHoverBackgroundColor:'#FF6B00',pointHoverBorderColor:'#fff',pointHoverBorderWidth:2,borderWidth:2.5};
  ...
  const gradFill3=makeGradientV2(c3ctx,'rgba(255,107,0,.45)','rgba(255,107,0,.08)','rgba(255,107,0,0)');
  ch3=new Chart(document.getElementById('ch3'),{
    type:'line',
    data:{labels:[],datasets:[
      {label:'مصرف',data:[],borderColor:'#FF6B00',backgroundColor:gradFill3,fill:true,tension:.45,pointRadius:0,pointHoverRadius:7,pointHoverBackgroundColor:'#fff',pointHoverBorderColor:'#FF6B00',pointHoverBorderWidth:3,borderWidth:3,order:2},
    ...
    options:{
      ...
      plugins:{
        legend:{display:false},
        tooltip:{
          backgroundColor:'rgba(20,20,20,.97)',borderColor:'rgba(255,107,0,.35)',borderWidth:1,
          titleColor:'#f5f5f5',bodyColor:'#cccccc',padding:13,cornerRadius:12,displayColors:true,boxPadding:4,
      ...
      scales:{
        x:{grid:{display:false},border:{display:false},ticks:{color:'#888888',font:{size:9.5,family:'Vazirmatn'},maxRotation:0}},
        y:{grid:{color:'rgba(255,107,0,.05)'},border:{display:false},ticks:{color:'#888888',font:{size:9.5,family:'Vazirmatn'},callback:v=>v+' MB'}}
      }
    }
  });
  ...
  ch2=new Chart(document.getElementById('ch2'),{
    ...
    data:{labels:['VLESS/WS','XHTTP Ultra','HTTP Proxy'],datasets:[{
      data:[55,35,10],
      backgroundColor:['#FF6B00','#10B981','#8B5CF6'],
      borderColor:getComputedStyle(document.documentElement).getPropertyValue('--card')||'#141414',
    ...
    options:{
      ...
      plugins:{
        ...
        tooltip:{backgroundColor:'rgba(20,20,20,.96)',borderColor:'rgba(255,107,0,.3)',borderWidth:1,padding:10,cornerRadius:10,bodyFont:{family:'Vazirmatn'},titleFont:{family:'Vazirmatn'}}
      }
    }
  });
}
let ws;
function wsLog(c,m){const l=document.getElementById('ws-log'),p=document.createElement('p');const colors={ok:'#34D399',err:'#F87171',info:'#cccccc',sent:'#FCD34D'};p.style.color=colors[c]||'#fff';p.textContent='['+new Date().toLocaleTimeString('fa-IR')+'] '+m;l.appendChild(p);l.scrollTop=l.scrollHeight}
