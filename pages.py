...
<div class="wrap">
  <div class="card">
    <div class="brand">
      ...
      <div><div class="brand-name">Tk-Ui</div><div class="brand-sub">v9.5</div></div>
    </div>
    <h1>ورود به پنل</h1>
...
:root{
  ...
  --card:#1a1a1a;--card-b:rgba(249,115,22,0.15);--card-bh:rgba(249,115,22,0.35);
  --accent:#F97316;--accent2:#FB923C;--accent-d:rgba(249,115,22,0.12);
  ...
  --purple:#9D7BF0;--purple-bg:rgba(157,123,240,0.1);
  --t1:#F5F5F5;--t2:#B0B0B0;--t3:#6B6B6B;
  --sidebar-w:248px;--radius:16px;
  --shadow:0 4px 24px rgba(0,0,0,0.5);
}
[data-theme="light"]{
  --bg:#F5F5F5;--bg2:#E8E8E8;--bg3:#DCDCDC;
  --card:#FFFFFF;--card-b:rgba(249,115,22,0.2);--card-bh:rgba(249,115,22,0.4);
  --accent:#EA580C;--accent2:#F97316;--accent-d:rgba(234,88,12,0.08);
...
.logo-img{width:38px;height:38px;border-radius:50%;overflow:hidden;border:1px solid var(--card-b);box-shadow:0 0 14px rgba(249,115,22,.3),0 0 8px rgba(249,115,22,.25);flex-shrink:0;display:flex;align-items:center;justify-content:center;background:var(--bg);color:var(--accent);font-weight:900;font-size:16px}
...
.tg-btn{display:flex;align-items:center;justify-content:center;gap:8px;background:linear-gradient(135deg,#F97316,#EA580C);color:#fff;border-radius:9px;padding:10px;font-size:12.5px;font-weight:600;font-family:inherit;border:none;cursor:pointer;width:100%;transition:.15s}
...
.traf-range-tab.on{background:var(--accent);color:#fff;box-shadow:0 2px 8px rgba(249,115,22,.35)}
...
.fi:focus,.fs:focus{border-color:rgba(249,115,22,.45);background:rgba(0,0,0,.25);box-shadow:0 0 0 3px rgba(249,115,22,.08)}
.fs option{background:var(--bg2)}
[data-theme="light"] .fs option{background:#fff}
.cl{background:var(--accent-d);border:1px solid rgba(249,115,22,.15);border-radius:10px;padding:11px 13px;font-size:11px;color:var(--t2);display:flex;gap:9px;align-items:flex-start;line-height:1.8;margin-top:12px}
...
.srv-hero-icon{width:50px;height:50px;border-radius:14px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:22px;flex-shrink:0;box-shadow:0 6px 18px rgba(249,115,22,.35)}
...
[data-theme="light"] .srv-tile{background:rgba(234,88,12,.03)}
...
.pw-hero-icon{width:50px;height:50px;border-radius:14px;background:linear-gradient(135deg,var(--purple),#6D48D6);display:flex;align-items:center;justify-content:center;color:#fff;font-size:22px;flex-shrink:0;box-shadow:0 6px 18px rgba(157,123,240,.35)}
...
.pw-input:focus{border-color:rgba(157,123,240,.5);box-shadow:0 0 0 3px rgba(157,123,240,.1)}
...
.pw-submit{width:100%;justify-content:center;background:linear-gradient(135deg,var(--purple),#6D48D6);color:#fff;border:none;border-radius:12px;padding:12px;font-family:inherit;font-size:13px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:8px;box-shadow:0 6px 18px rgba(157,123,240,.32);transition:.18s}
.pw-submit:hover{transform:translateY(-2px);box-shadow:0 10px 24px rgba(157,123,240,.42)}
...
.sub-box{background:rgba(157,123,240,.07);border:1px solid rgba(157,123,240,.2);border-radius:10px;padding:14px 16px;display:flex;align-items:center;justify-content:space-between;gap:10px;flex-wrap:wrap;margin-top:11px}
...
.subs-search input:focus{border-color:rgba(157,123,240,.5);box-shadow:0 0 0 3px rgba(157,123,240,.1)}
...
.sub-card-top::before{content:'';position:absolute;top:-30px;left:-30px;width:130px;height:130px;background:radial-gradient(circle,rgba(157,123,240,.14),transparent 70%);pointer-events:none}
.sub-card-head-v2{display:flex;align-items:flex-start;gap:13px;position:relative;z-index:1}
.sub-card-icon{width:46px;height:46px;border-radius:14px;background:linear-gradient(135deg,var(--purple),#6D48D6);display:flex;align-items:center;justify-content:center;color:#fff;font-size:20px;flex-shrink:0;box-shadow:0 6px 16px rgba(157,123,240,.35)}
...
.sub-card-url-row{margin:14px 20px 0;background:rgba(157,123,240,.08);border:1px dashed rgba(157,123,240,.25);border-radius:11px;padding:9px 12px;display:flex;align-items:center;gap:8px}
...
.modal-v2-head::before{content:'';position:absolute;top:-50px;left:-50px;width:160px;height:160px;background:radial-gradient(circle,rgba(157,123,240,.2),transparent 70%);pointer-events:none}
...
.modal-v2-input:focus{border-color:rgba(157,123,240,.55);box-shadow:0 0 0 3px rgba(157,123,240,.12);background:rgba(0,0,0,.28)}
[data-theme="light"] .modal-v2-input:focus{background:#fff}
.modal-v2-input:focus~i{color:var(--purple)}
.modal-v2-hint{background:rgba(249,115,22,.08);border:1px solid rgba(249,115,22,.18);border-radius:11px;padding:9px 12px;font-size:10px;color:var(--t2);display:flex;gap:7px;align-items:flex-start;line-height:1.6;margin-top:2px}
...
.lmodal-icon{width:44px;height:44px;border-radius:13px;background:linear-gradient(135deg,var(--accent),var(--accent2));display:flex;align-items:center;justify-content:center;color:#fff;font-size:19px;flex-shrink:0;box-shadow:0 6px 16px rgba(249,115,22,.35)}
...
.lmodal-search input:focus{border-color:rgba(249,115,22,.5);box-shadow:0 0 0 3px rgba(249,115,22,.1)}
...
.lmodal-qbtn:hover{background:rgba(249,115,22,.2)}
...
.lrow-v2.checked{background:rgba(249,115,22,.1);border-color:rgba(249,115,22,.25)}
...
.lrow{display:flex;align-items:center;gap:8px;padding:7px 0;border-bottom:1px solid rgba(249,115,22,.05)}
...
.cfg-uuid-mini:hover{background:rgba(249,115,22,.2)}
...
.log-item{display:flex;gap:12px;padding:11px 0;border-bottom:1px solid rgba(249,115,22,.05);position:relative}
...
.erow{padding:9px 0;border-bottom:1px solid rgba(249,115,22,.05)}
...
<div class="mob-top">
  <div class="ml">
    <div class="mob-logo">Tk</div>
    <span class="mob-title">Tk-Ui</span>
  </div>
  <div class="mob-right">
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    <div class="logo-img">Tk</div>
    <div><div class="logo-name">Tk-Ui</div><div class="logo-sub">v9.5</div></div>
  </div>
  <div class="nav-wrap">
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">Tk-Ui v9.5 · Railway</span>
    <a class="df-link" href="https://t.me/ItzJustEren" target="_blank"><i class="ti ti-brand-telegram"></i> @ItzJustEren</a>
    <a class="df-link" href="https://t.me/TaaKaaOrg" target="_blank"><i class="ti ti-brand-telegram"></i> @TaaKaaOrg</a>
  </div>
</section>
...
<section class="pg" id="pg-support">
  ...
  <div class="srv-panel">
    <div class="srv-hero">
      ...
      <div class="srv-hero-text">
        <div class="srv-hero-domain">پشتیبانی Tk-Ui</div>
        <div class="srv-hero-sub"><span class="dot dg pulse"></span> راه‌های ارتباطی با تیم Tk-Ui</div>
      </div>
    </div>
    <div class="srv-tiles">
      ...
      <a class="srv-tile" href="https://t.me/ItzJustEren" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-telegram"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">آیدی تلگرام</div><div class="srv-tile-val">@ItzJustEren</div></div>
      </a>
      <a class="srv-tile" href="https://t.me/TaaKaaOrg" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-users-group"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">کانال تلگرام</div><div class="srv-tile-val">@TaaKaaOrg</div></div>
      </a>
      <a class="srv-tile" href="#" target="_blank" style="text-decoration:none;cursor:pointer;opacity:0.7">
        <div class="srv-tile-icon"><i class="ti ti-speakerphone"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">گروه تلگرام</div><div class="srv-tile-val">Coming soon</div></div>
      </a>
      <a class="srv-tile" href="https://github.com/ItzJustEren" target="_blank" style="text-decoration:none;cursor:pointer">
        <div class="srv-tile-icon"><i class="ti ti-brand-github"></i></div>
        <div class="srv-tile-text"><div class="srv-tile-label">گیت‌هاب</div><div class="srv-tile-val">github.com/ItzJustEren</div></div>
      </a>
    </div>
  </div>
</section>
...
function checkPwStrength(val){
  ...
  const colors=['#EF4444','#F59E0B','#F97316','#10B981'],labels=['خیلی ضعیف','ضعیف','متوسط','قوی'];
...
function initCharts(){
  ...
  const grad1=makeGradient(c1,'rgba(249,115,22,.38)','rgba(249,115,22,0)');
  const opts={
    ...
    plugins:{
      ...
      tooltip:{
        backgroundColor:'rgba(20,20,20,.96)',borderColor:'rgba(249,115,22,.3)',borderWidth:1,
        titleColor:'#F5F5F5',bodyColor:'#B0B0B0',padding:11,cornerRadius:10,displayColors:false,
    ...
    scales:{
      ...
      y:{grid:{color:'rgba(249,115,22,.06)'},border:{display:false},ticks:{color:'#6B6B6B',font:{size:9,family:'Vazirmatn'},callback:v=>v+' MB'}}
    },
    elements:{line:{capBezierPoints:true}}
  };
  const ds1={label:'MB',data:[],borderColor:'#F97316',backgroundColor:grad1,fill:true,tension:.42,pointRadius:0,pointHoverRadius:6,pointHoverBackgroundColor:'#F97316',pointHoverBorderColor:'#fff',pointHoverBorderWidth:2,borderWidth:2.5};
  ...
  const gradFill3=makeGradientV2(c3ctx,'rgba(249,115,22,.45)','rgba(249,115,22,.08)','rgba(249,115,22,0)');
  ch3=new Chart(document.getElementById('ch3'),{
    type:'line',
    data:{labels:[],datasets:[
      {label:'مصرف',data:[],borderColor:'#F97316',backgroundColor:gradFill3,fill:true,tension:.45,pointRadius:0,pointHoverRadius:7,pointHoverBackgroundColor:'#fff',pointHoverBorderColor:'#F97316',pointHoverBorderWidth:3,borderWidth:3,order:2},
    ...
    options:{
      ...
      plugins:{
        legend:{display:false},
        tooltip:{
          backgroundColor:'rgba(20,20,20,.97)',borderColor:'rgba(249,115,22,.35)',borderWidth:1,
          titleColor:'#F5F5F5',bodyColor:'#B0B0B0',padding:13,cornerRadius:12,displayColors:true,boxPadding:4,
      ...
      scales:{
        ...
        y:{grid:{color:'rgba(249,115,22,.05)'},border:{display:false},ticks:{color:'#6B6B6B',font:{size:9.5,family:'Vazirmatn'},callback:v=>v+' MB'}}
      }
    }
  });
  ...
  ch2=new Chart(document.getElementById('ch2'),{
    ...
    data:{labels:['VLESS/WS','XHTTP Ultra','HTTP Proxy'],datasets:[{
      ...
      borderColor:getComputedStyle(document.documentElement).getPropertyValue('--card')||'#1a1a1a',
    ...
    options:{
      ...
      plugins:{
        ...
        tooltip:{backgroundColor:'rgba(20,20,20,.96)',borderColor:'rgba(249,115,22,.3)',borderWidth:1,padding:10,cornerRadius:10,bodyFont:{family:'Vazirmatn'},titleFont:{family:'Vazirmatn'}}
      }
    }
  });
}
let ws;
function wsLog(c,m){const l=document.getElementById('ws-log'),p=document.createElement('p');const colors={ok:'#34D399',err:'#F87171',info:'#B0B0B0',sent:'#FCD34D'};p.style.color=colors[c]||'#fff';p.textContent='['+new Date().toLocaleTimeString('fa-IR')+'] '+m;l.appendChild(p);l.scrollTop=l.scrollHeight}
...
:root{{
  --bg:#0a0a0a;--bg2:#141414;--bg3:#1e1e1e;
  --card:#1a1a1a;--card-b:rgba(249,115,22,0.15);--card-bh:rgba(249,115,22,0.35);
  --accent:#F97316;--accent2:#FB923C;--accent-d:rgba(249,115,22,0.1);
  --green:#10B981;--green-bg:rgba(16,185,129,0.1);--green-t:#34D399;
  --red:#EF4444;--red-bg:rgba(239,68,68,0.1);--red-t:#F87171;
  --amber:#F59E0B;--amber-bg:rgba(245,158,11,0.1);--amber-t:#FCD34D;
...
.bg-fx{{position:fixed;inset:0;background:radial-gradient(ellipse 70% 45% at 50% -8%,rgba(249,115,22,0.13),transparent 62%),var(--bg);z-index:0;pointer-events:none;transition:background .35s}}
.grid-fx{{position:fixed;inset:0;background-image:linear-gradient(rgba(249,115,22,0.025) 1px,transparent 1px),linear-gradient(90deg,rgba(249,115,22,0.025) 1px,transparent 1px);background-size:46px 46px;z-index:0;pointer-events:none}}
...
.brand-img{{width:40px;height:40px;border-radius:50%;overflow:hidden;border:1px solid var(--card-b);box-shadow:0 0 14px rgba(249,115,22,.3),0 0 8px rgba(249,115,22,.25);flex-shrink:0;display:flex;align-items:center;justify-content:center;background:var(--bg);color:var(--accent);font-weight:900;font-size:18px}}
...
.sub-info::before{{content:'';position:absolute;top:0;right:0;width:160px;height:160px;background:radial-gradient(circle at top right,rgba(249,115,22,.1),transparent 70%);pointer-events:none}}
...
.copy-all-bar{{display:flex;align-items:center;gap:12px;background:linear-gradient(120deg,var(--accent) 0%,#EA580C 100%);border-radius:18px;padding:16px 19px;margin-bottom:18px;box-shadow:0 10px 30px rgba(249,115,22,.28);flex-wrap:wrap}}
...
.copy-all-btn{{background:#fff;color:#EA580C;border:none;border-radius:12px;padding:10px 19px;font-family:inherit;font-size:12.5px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:6px;transition:.18s;white-space:nowrap}}
...
[data-theme="light"] .cfg-vless{{background:rgba(234,88,12,.05)}}
...
.btn-g{{background:var(--accent-d);color:var(--accent2);border:1px solid rgba(249,115,22,.16)}}
...
[data-theme="light"] .lock-inp{{background:rgba(234,88,12,.04)}}
...
<div class="wrap">
  ...
  <div class="footer">پشتیبانی: <a href="https://t.me/ItzJustEren" target="_blank">@ItzJustEren</a> · کانال: <a href="https://t.me/TaaKaaOrg" target="_blank">@TaaKaaOrg</a> · Tk-Ui v9.5</div>
</div>
<script>
...
function renderContent(d){{
  ...
  window._tkSubUrl  = subUrl;
  window._tkSubName = d.name;
  window._tkLinks   = d.links.map(l => ({{
    vless : l.vless_link,
    ...
    <div class="sub-info">
      ...
      <div class="sub-sub-box">
        ...
        <button class="btn btn-pur" style="padding:7px 12px;font-size:10.5px"
          onclick="navigator.clipboard.writeText(window._tkSubUrl).then(()=>toast('لینک ساب کپی شد ✓','ok'))">
          <i class="ti ti-copy"></i> کپی لینک ساب
        </button>
        <button class="btn btn-g" style="padding:7px 12px;font-size:10.5px"
          onclick="showQR(window._tkSubName + ' — کل گروه', window._tkSubUrl)">
            ...
            <div class="cfg-bottom">
              ...
              <div class="cfg-actions">
                <button class="btn btn-p"
                  onclick="navigator.clipboard.writeText(window._tkLinks[${{i}}].vless).then(()=>toast('لینک کپی شد ✓','ok'))">
                  <i class="ti ti-copy"></i> کپی لینک
                </button>
                <button class="btn btn-g"
                  onclick="showQR(window._tkLinks[${{i}}].label, window._tkLinks[${{i}}].vless)">
